...
function validar(){
  let control_1 =Number(document.querySelector(".control_1").value);
  let control_2 =Number(document.querySelector(".control_2").value);
  let control_3 =Number(document.querySelector(".control_3").value);
    
  if(control_1<= 0 || control_2 <=0 || control_3<=0){
